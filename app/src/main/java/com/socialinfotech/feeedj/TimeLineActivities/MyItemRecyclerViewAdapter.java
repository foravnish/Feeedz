...
//                headerHolder.sdv_add_iamge.setImageURI(Uri.parse(mValues[position-1].getOfferImage()));
                ...
                pagerAdapter = new Pager(Arrays.asList(mValues), mContext,mValues[position-1].getOfferImages(),mValues[position-1].getOfferImage(),mValues[position-1].getAttachmentHTML(),mValues[position-1].getCompany());
